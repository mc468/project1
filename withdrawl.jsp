...
<font color="#000000"><strong>user withdrawl</strong></font>
</td>     
</tr>
<tr>           
<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" style="background-color: rgb(192, 192, 192);"">             
<font color="#000000" style="background-color:  rgb(192, 192, 192);""><strong>Withdrawl Amount:</strong></font>
</td> 
<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" style="background-color: rgb(192, 192, 192);">        
...
<strong><input type="submit" value="Withdrawl"></strong>                      
</td>    
</center>
</body> 
</html>
